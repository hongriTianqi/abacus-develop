...
void SpinConstrain<FPTYPE, Device>::init_sc(double sc_thr_in, int nsc_in, int nsc_min_in, double alpha_trial_in,
                                            double sccut_in, bool decay_grad_switch_in, const UnitCell& ucell,
                                            std::string sc_file, int NPOL, Parallel_Orbitals* ParaV_in, int nspin_in,
                                            K_Vectors kv_in, std::string KS_SOLVER_in, LCAO_Matrix* LM_in,
                                            hsolver::HSolver<FPTYPE, Device>* phsol_in,
                                            hamilt::Hamilt<FPTYPE, Device>* p_hamilt_in, psi::Psi<FPTYPE>* psi_in,
